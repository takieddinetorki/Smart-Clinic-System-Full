        ...
        <div class="main">
            ...
            <div style="width:100%; display: flex; justify-content: center;">
                ...
                <div class="tabl table-wrapper-scroll-y">
                    ...
                    <div class="table" style="min-width: fit-content">
                        <div style="max-height: calc(100vh - 300px);min-height: 300px; padding-right: 10px;"
                            class="table-wrapper-scroll-y">
                            <div class="appointment-row">
                                <div style="display: flex; width: 370px; margin-left:10px; ">
                                    <a href=" "><i class="fas fa-eye"></i></a>
                                    <span style="margin-right:20px; font-weight: 600;" id="ID">J123456789H</span>
                                    <span id="name">JANE DOE</span>
                                </div>

                                <div style="width: 150px;" id="date">
                                    <span id="date1">02/12/19</span>
                                    <br>
                                    <span id="dayName">Tuesday</span>
                                </div>
                                <div style="width: 150px;" id="time">9 am - 10 am</div>
                                <div style="width: 150px;" id="docName">Dr. Jane Doe</div>
