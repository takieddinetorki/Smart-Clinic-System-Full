...
class ID 
{
    ...
    public function generateID($type){
        switch($type){
            case 'staff' : return "{$this->clinic}{$this->currentYear}ST{$this->random}{$this->time}"; break;
            case 'doctor' : return "{$this->clinic}{$this->currentYear}DR{$this->random}{$this->time}"; break;
            case 'pharmacist' : return "{$this->clinic}{$this->currentYear}PC{$this->random}{$this->time}"; break;
            case 'patient' : return "PID{$this->currentYear}{$this->random}{$this->time}"; break;
            case 'appointment' : return "A{$this->currentDay}{$this->currentMonth}{$this->random}{$this->time}"; break;
            case 'medicine' : return "MD{$this->random}{$this->time}"; break;
            case 'accountCode' : return "AC{$this->time}"; break;
            case 'voucherNo' : return "VN{$this->time}"; break;
            case 'vendor' : return "VD{$this->random}{$this->time}"; break;
            case 'inventory' : return "{$this->clinic}IR{$this->time}"; break;
