    ...
    if (Token::check(Session::get('token'))) {
        try {
            ...
            if ($FileExt) {
                ...
                // echo  $picture;
                $patientData['picture'] = escape($picture);
            }
            ...
            $medicalData = array(
                ...
                'othersHabit' => (Input::get('othersHabitText', true)),
            ...
            if ($patient->editPatient($pid, $patientData) && $patient->editMedicalHistory($pid, $medicalData)) {
