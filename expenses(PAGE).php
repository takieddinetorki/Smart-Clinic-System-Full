...
<body>
    <div class="container" id="container">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <a href="expenses(PAGE).html" class="nav-active"><img src="src/img/prescription.svg" alt="" />
            ...
            <div style="width: 100%; max-width: 1050px;">
                <div class="tabl">
                    ...
                    <div class="table-wrapper-scroll-y" style="overflow-y: hidden;">
                        ...
                        <table class="table" style="max-width: 1050; min-width: 1050px;">
                            ...
                            <tbody style="max-height: calc(100vh - 385px);min-height: 200px;"
                ...
                <div class="footer">
                    <div class="footer-div">
                        <div class="icons-div">
                            <div class="icons">
                                <a href="expenses_form(PAGE).html" style="text-decoration: none;"> <i style="color: #444242;" class="fas fa-plus"></i></a>
        ...
        <div class="modalContent1">
            <form style="margin-top: 7px;">
                ...
                <div class="form-div-modal">
                    ...
                    <span>
                        <input type="text" id="from" class="inp-modal datepicker-here" data-language="en"><i
                            class="far fa-calendar-alt" style="font-size: 12;"></i>
                    </span>
                </div>
                <div class="form-div-modal">
                    <label for="to" class="label-modal">Ending Date</label>
                    <span>
                        <input type="text" id="to" class="inp-modal datepicker-here" data-language="en"><i
                            class="far fa-calendar-alt" style="font-size: 12;"></i>
                    </span>
                </div>
            </form>
