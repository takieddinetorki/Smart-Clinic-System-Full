...
<body>
        ...
        <div class="header">
            ...
            <div class="nav-images">
                ...
                <div class="dropdown-notification">
                    ...
                    <a id="notif"><img src="src/img/mark.png"style="width:21px;height:21px;margin-bottom:22px;margin-left:-22px" alt=""></a>
                    <div class="dropdown-content">
                        <a href="#">You have missed an appointment</a>
                        <a href="#" onclick="hideNotifIcon()">Clear all notification</a>
                    </div>
                </div>
                    ...
                    <div class="form-content">
                        <form class="half1">
                            ...
                            <div class="form-section">
                                ...
                                <input required  type="text" id="first-name" onchange="checkletter1()">
                            </div>
                            <div class="form-section">
                                <label for="">Last Name</label>
                                <input required  type="text" id="last-name" onchange="checkletter2()">
                            </div>
                            <div class="form-section">
                                <label for="">Mobile Number</label>
                                <input required  type="text" id="mobile-number" onchange="changedinput()">
                            </div>
                            <div class="form-section">
                                <label for="">Email</label>
                                <input required  type="text" id="email" readonly onchange="checkemail()" placeholder="read-only">
                            </div>
                        </form>
                        <form class="half2">
                            <div class="form-section">
                            ...
                            <div class="form-section">
                                ...
                                <input required  type="text" id="birthday" class="datepicker-here" data-language='en'>
                                <i style="color:#707070;position:relative;right:32px;top:14px;font-size:18px"
                            ...
                            <div class="form-section">
                                <div style="display: none;" id="pasword-ins">
                                    <p>Must contain uppercase, lowercase alphabet, 
                                        numeric and a special character</p>
                                    <p>Minimum of 8 characters.</p>
                                </div>
                                <label for="" id="pass-label">Password</label>
                                <input required  type="password" onmouseover="tooltip('pasword-ins',1)" onmouseout="tooltip('pasword-ins',0)" id="password">
                               
                            </div>
                            
                            <div class="form-section">
                                <label for="" style="padding-top:0px;">Confirm <br>Password</label>
    ...
    <script>
        ...
        function tooltip(id,display) {
            if(display==1){
                document.getElementById(id).style.display = "block";
            }else{
                document.getElementById(id).style.display = "none";
            }
            document.getElementById('pass-label').classList.toggle("pass-ml");
