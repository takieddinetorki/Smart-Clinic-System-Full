                        ...
                        <table class="table" style="max-width: 1050; min-width: 1050px;">
                            ...
                            <tbody style="max-height: calc(100vh - 330px);min-height: 200px;"
                                ...
                                <tr>
                                    ...
                                    <td style="width:500px" class="patient-name-col">JOHN DOE</td>
                                    <td style="width:207px;border-right:none;">MALE</td>
                                </tr>
                                <tr>
                                    <td style="border-left: none;">1</td>
                                    <td>JA000906000</td>
                                    <td class="patient-name-col">JOHN DOE</td>
                                    <td style="border-right:none">MALE</td>
