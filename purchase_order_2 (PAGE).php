        ...
        <div class="main">
            <div class="main-container">
                ...
                <div class="top-items">
                    ...
                    <div class="cl-btn">
                        <a href="purchase_order_table (PAGE).html">    <i class="fas fa-times-circle"></i></a>
            ...
            <div class="footer">
                <div class="footer-div">
                    <div class="dots-div">
                        <a href="purchase_order_2 (PAGE).html" style="text-decoration: none;"> <span class="dot" style="background-color: black;"></span></a>
                        <a href="purchase_order (PAGE).html" style="text-decoration: none;"><span class="dot"></span></a>
                    </div>
                    <div class="icons-div">
                        <div class="icons">
