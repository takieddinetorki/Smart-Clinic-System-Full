                    ...
                    <div class="personal-form">
                        <div class="box1">
                            <div class="form-part1">
                                <div class="form-row" style="margin-top:10px;">
                                    ...
                                    <label class="passport-no-label"
                                        style="width:80px;text-align:center;padding-top:0px;">NRIC/<br>Passport</label>
                                    <input type="text" class="passport-no">
                                    <label style="width:80px;text-align:center" class="dob-label">D.O.B</label>
                                    <input type="text" onfocusout="calcAge('dob-input','age-input')"
                                        class="dob datepicker-here" data-language='en' id="dob-input">
                            ...
                            <div class="photo-part">
                                <div class="photo-input">
                                    ...
                                    <input type="file"
                                        style="width:100%;height:100%;transform: translateY(-180px);background:rgba(0, 0, 255, 0.397);opacity:0"
                                        name="fileToUpload" onchange="readURL(this);" id="file-inputs" />
                        ...
                        <div class="box2">
                            <div class="form-row" style="margin-bottom:12px;">
                                ...
                                <label for="matrial"
                                    style="width:100px;text-align:right;padding-right:5px;">National</label>
                                ...
                                <label for="status" style="width:140px;text-align:right;padding-right:5px;">Marital
                                    Status</label>
                                <input type="radio" name="status" value="single" id="ms_single" oninput="hideSingle()"
                                    style="margin-top:8px;color:black;" />
                                <label for="single" style="width:50px;">Single</label>
                                <input type="radio" name="status" value="married" oninput="hideSingle()"
                                    style="margin-top:8px;color:black;" />
                                <label for="married" style="width:50px;">Married</label>
                            </div>
                            <div class="form-row">
                                <label for="mobile">Mobile No</label>
                                <input type="text" name="mobile" class="mobile-no" id="mobile-number"
                                    onchange="changedinput1()" />
                                <label for="spouse-name"
                                    style="width:80px;padding-left:25px;padding-top:0px;margin-right:15px;"
                                    id="spouse-label">Spouse Name</label>
                                <input type="text" id="spouse-input" class="spouse-name">
                            </div>
                            <div class="form-row">
                                <label for="emergency-name"
                                    style="padding-top:0px;transform: translateY(-1.5vh);">Emergency<br>Contact<br>Name</label>
                                <input type="text" name="mobile" class="emergency-name" />
                                <label for="emergency-no"
                                    style="width:80px;padding-left:25px;padding-top:0px;margin-right:15px;">Emergency
                                    Contact No</label>
                            ...
                            <div class="form-row" style="margin-bottom:5px;">
                                ...
                                <label for="doctor"
                                    style="width:80px;padding-left:25px;padding-top:0px;margin-right:15px;">Doctor</label>
